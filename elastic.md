...
10. 定义映射： **新建索引** PUT {"**mappings**":{"gb":{"**properties**":{"tweet":{"type":"string","**analyzer**":"english"}}}}}。**添加字段**： **PUT** {"**properties**":{"tag":{"type":"string","**index**":"**not_analyzed**"}}}。**测试映射**：GET /gb/_analyze?field=tweet -d "{Black-cats}"。
